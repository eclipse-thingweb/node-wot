...
Promise.all(fetchArray).then(async (tdArray) => {
    ...
    setInterval(() => {
        PumpP101.readProperty("status")
            ...
            .catch((err) => {
                console.error("--- PumpStatus read error: " + err);
            });
        ValveV102.readProperty("status")
            ...
            .catch((err) => {
                console.error("--- ValveStatus read error: " + err);
            });
        UltrasonicSensorB101.readProperty("levelvalue")
            ...
            .catch((err) => {
                console.error("--- Tank102LevelValue read error: " + err);
            });
        FloatSwitchS112.readProperty("overflow102")
            ...
            .catch((err) => {
                console.error("--- Tank102OverflowStatus read error: " + err);
            });
        LevelSensorB114.readProperty("maxlevel101")
            ...
            .catch((err) => {
                console.error("--- Tank101MaximumLevelStatus read error: " + err);
            });
        LevelSensorB113.readProperty("minlevel101")
            ...
            .catch((err) => {
                console.error("--- Tank101MinimumLevelStatus read error: " + err);
            });
        LevelSwitchS111.readProperty("overflow101")
            ...
            .catch((err) => {
                console.error("--- Tank101OverflowStatus read error: " + err);
            });
    }, 5000);
});
        ...
        thing.setActionHandler("StartPump", () => {
            return new Promise((resolve, reject) => {
                ...
                PumpP101.invokeAction("on")
                    ...
                    .catch((err) => {
                        console.error("--- StartPump invoke error: " + err);
                        reject(err);
                    });
                resolve();
            });
        ...
        thing.setActionHandler("StopPump", () => {
            return new Promise((resolve, reject) => {
                ...
                PumpP101.invokeAction("off")
                    ...
                    .catch((err) => {
                        console.error("--- StopPump invoke error: " + err);
                        reject(err);
                    });
                resolve();
            });
        ...
        thing.setActionHandler("OpenValve", () => {
            return new Promise((resolve, reject) => {
                ...
                ValveV102.invokeAction("open")
                    ...
                    .catch((err) => {
                        console.error("--- OpenValve invoke error: " + err);
                        reject(err);
                    });
                resolve();
            });
        ...
        thing.setActionHandler("CloseValve", () => {
            return new Promise((resolve, reject) => {
                ...
                ValveV102.invokeAction("close")
                    ...
                    .catch((err) => {
                        console.error("--- CloseValve invoke error: " + err);
                        reject(err);
                    });
                resolve();
            });
